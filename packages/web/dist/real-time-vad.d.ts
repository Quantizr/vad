...
export declare class AudioNodeVAD {
    ...
    constructor(ctx: AudioContext, options: RealTimeVADOptions, frameProcessor: FrameProcessor, entryNode: AudioWorkletNode, pitchShift: PitchShift);
    pause: () => void;
    start: () => void;
    receive: (node: AudioNode) => void;
    updateAudioSpeed: (speed: number) => void;
